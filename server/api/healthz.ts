...
// import { sleep, type WhisperConfig, type WhisperModel } from "~~/shared";
// import { initFFmpeg } from "../lib/ffmpeg/ffmpeg";
// import { initPixels } from "../lib/pixels/pixels";
// import { initWhisper } from "../lib/whisper/whisper";
...
//     const pixels = await withInit("Pixels", isPixelsInitialized, async () => initPixels({ apiKey: PEXELS_API_KEY }), 300, write);
